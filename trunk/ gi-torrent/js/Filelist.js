jsx3.lang.Package.definePackage(
  "Filelist.service",                //the full name of the package to create
  function(service) {          //name the argument of this function

    //call this method to begin the service call (Filelist.service.call();)
    service.call = function() {
      var objService = giTorrent.loadResource("Filelist_xml");
