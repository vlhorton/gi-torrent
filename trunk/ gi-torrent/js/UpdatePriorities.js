jsx3.lang.Package.definePackage(
  "UpdatePriorities.service",                //the full name of the package to create
  function(service) {          //name the argument of this function

    //call this method to begin the service call (UpdatePriorities.service.call();)
    service.call = function() {
      var objService = giTorrent.loadResource("UpdatePriorities_xml");
