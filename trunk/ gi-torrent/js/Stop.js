jsx3.lang.Package.definePackage(
  "stop.service",                //the full name of the package to create
  function(service) {          //name the argument of this function

    //call this method to begin the service call (stop.service.call();)
    service.call = function() {
      var objService = giTorrent.loadResource("Stop_xml");
