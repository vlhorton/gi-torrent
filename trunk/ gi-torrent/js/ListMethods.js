jsx3.lang.Package.definePackage(
  "ListMethods.service",       //the full name of the package to create
  function(service) {          //name the argument of this function

    //call this method to begin the service call (listMethods.service.call();)
    service.call = function() {
      var objService = gTorrent.loadResource("rules");
      objService.setOperation("");
      objService.setEndpointURL("http://192.168.1.190:8181/RPC2");
