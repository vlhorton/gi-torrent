jsx3.lang.Package.definePackage(
  "SetMaxUpCount.service",   //the full name of the package to create
  function(service) {          //name the argument of this function

    //call this method to begin the service call (SetMaxUpCount.service.service.call();)
    service.call = function() {
      var objService = giTorrent.loadResource("SetMaxUpCount_xml");
