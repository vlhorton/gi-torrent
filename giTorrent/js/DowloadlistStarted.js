jsx3.lang.Package.definePackage(
  "downloadlistStarted.service",                //the full name of the package to create
  function(service) {          //name the argument of this function
    //call this method to begin the service call (downloadlistStarted.service.call();)
    service.call = function() {
      var objService = giTorrent.loadResource("DownloadlistStarted_xml");
      ...
      {
         TimeoutID = window.setTimeout(downloadlistStarted.service.call, giTorrent.getJSXByName("Refresh_Interval").getValue() * 1000);
