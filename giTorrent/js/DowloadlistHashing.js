jsx3.lang.Package.definePackage(
  "downloadlistHashing.service",                //the full name of the package to create
  function(service) {          //name the argument of this function
    //call this method to begin the service call (downloadlistHashing.service.call();
    service.call = function() {
      var objService = giTorrent.loadResource("DownloadlistHashing_xml");
      ...
      {
         TimeoutID = window.setTimeout(downloadlistHashing.service.call, giTorrent.getJSXByName("Refresh_Interval").getValue() * 1000);
